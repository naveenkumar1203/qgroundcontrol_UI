...
Item {
    ...
    MessageDialog{
        id:messagedialog
        text:qsTr("Model A - The checksum matches. Please continue")
    }

    MessageDialog{
        id:messagedialog1
        text:qsTr("Model B - The checksum matches. Please continue")
    }

    MessageDialog{
        id:messagedialog2
        text:qsTr("Model and Vehicle does not Match. Please contact OEM")
    }
