...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(window,               "#05324d", "#05324d", "#05324d", "#05324d")
    ...
    //DECLARE_QGC_COLOR(windowShadeLight,     "red", "red", "red", "red")
    DECLARE_QGC_COLOR(windowShade,          "#05324D", "#05324D", "#05324D", "#05324D")
    DECLARE_QGC_COLOR(windowShadeDark,      "#05324D", "#05324D", "#05324D", "#05324D")
    ...
    DECLARE_QGC_COLOR(button,               "#031C28", "#031C28", "#031C28", "#031C28")
    ...
    DECLARE_QGC_COLOR(buttonHighlight,      "#F25822", "#F25822", "#F25822", "#F25822")
    ...
    DECLARE_QGC_COLOR(textField,            "#031C28", "#031C28", "#031C28", "#031C28")
    DECLARE_QGC_COLOR(textFieldText,        "#ffffff", "#ffffff", "#ffffff", "#ffffff")
    ...
    DECLARE_QGC_COLOR(colorYellow,           "#FFFF00", "#FFFF00", "#FFFF00", "#FFFF00")
    ...
    DECLARE_QGC_COLOR(missionItemEditor,    "#031C28", "#031C28", "#031C28", "#031C28")
    DECLARE_QGC_COLOR(toolStripHoverColor,  "#F25822", "#F25822", "#F25822", "#F25822")
    ...
    DECLARE_QGC_COLOR(toolbarBackground,    "#031C28", "#031C28", "#031C28", "#031C28")
    DECLARE_QGC_COLOR(newstriptoolbarBackground,    "#40031C28", "#40031C28", "#40031C28", "#40031C28")
    ...
    DECLARE_QGC_SINGLE_COLOR(mapMissionTrajectory,          "#368BC1")
