...
ApplicationWindow {
    ...
    RpaDatabase {
        ...
        onUin_record_notfound: {
            ...
            //firebase.access_firebase(drone_type_list.currentText,drone_model_list.currentText,drone_name_text.text,uin_input_text.text)
        ...
        Column{
            ...
            Button {
                ...
                onClicked: {
                    ...
                    //if(forgot_password_mail_text.text !== database_access.mail){
                    //database.forgotPasswordmail(forgot_password_mail_text.text)
    ...
    Rectangle{
        ...
        Label{
            ...
            Label{
                anchors.top: parent.bottom
                anchors.topMargin: 20
                text: qsTr("- Lets get the access for our best service")
                color: "#F25822"
                font.pointSize:ScreenTools.defaultFontPointSize            }
            MouseArea{
                anchors.fill: parent
                ...
                ScrollView {
                    ...
                    Column{
                        ...
                        MessageDialog {
                            ...
                            text: qsTr("Please provide a Valid Mobile Number")
                        }
            ...
            Column{
                ...
                Button {
                    ...
                    onClicked: {
                        ...
                        database_access.new_user_registration(combobox_text.text,user_name_text.text,user_mail_text.text,user_number_text.text,user_address_text.text,user_locality_text.text,user_password_text.text)
                        //                        new_user_first_page.visible = false
                        //                        third_user_details_page.visible = false
                        //                        second_user_details_page.visible = false
                        //                        first_circle.color = "#F25822"
    ...
    MessageDialog {
        ...
        text: qsTr("Entered Name is Already Registered.")
        standardButtons: Dialog.Ok
        onButtonClicked: {
            user_name_text.text = ""
        }
    ...
    MessageDialog {
        ...
        text: qsTr("Entered Mail is Already Registered.")
        standardButtons: Dialog.Ok
        onAccepted: {
            user_mail_text.text = ""
        }
    ...
    MessageDialog {
        ...
        text: qsTr("Entered Number is Already Registered.")
        standardButtons: Dialog.Ok
        onAccepted: {
            user_number_text.text = ""
        }
    ...
    MessageDialog {
        ...
        text: qsTr("Entered UIN is Already Used.")
        standardButtons: Dialog.Ok
    ...
    MessageDialog {
        ...
        title: "Wrong Mail ID"
        text: qsTr("Please provide your Valid Mail Id")
    }

    MessageDialog {
        id: connection_not_established_dialog
        title: "Connection Lost"
        text: qsTr("Connection not established, Please try after Sometime.")
    }
    MessageDialog {
        id: connectionLostdialog
        title: "Connection Lost"
        text: qsTr("Connection Lost, Please check your Internet Connection.")
    }
    MessageDialog {
        id: enter_all_fields
        title: "Somefield not filled"
        text: qsTr("Please fill all the details")
    }
    MessageDialog {
        id: password_mismatch
        title: "Mismatch"
        text: qsTr("Both passwords do not match")
    }
    MessageDialog {
        id: password_length_error_dialog
        title: "Password Length Error"
        text: qsTr("Password Length must be greater than 6")
    }
    MessageDialog {
        id: password_updated
        title: "Updated"
        //text: qsTr("Password changed and Updated.")
        text: qsTr("Reset your password using the link sent to your registered Mail.")
    }
            ...
            Rectangle {
                            ...
                            Row{
                                ...
                                Row {
                                    ...
                                    Rectangle {
                                        id:row_rectangle1
                                        color: "#4D05324D"
                                        width: mainWindow.height /4; height: width
                                        radius: 2
                ...
                Rectangle {
                    ...
                    Rectangle{
                        ...
                        MessageDialog{
                            id:fillDialog
                            text:qsTr("please fill the details correctly")
                        }

                        MessageDialog{
                            id:uinDialog
                            text:qsTr("Registered Successfully.")
                        }
                        MessageDialog{
                            id:tableDialog
                            text:qsTr("Updated Successfully.")
                        }
                        MessageDialog{
                            id:deleteDialog
                            text:qsTr("Row Deleted Successfully.")
                        }
                    }
            ...
            Rectangle{
                ...
                Rectangle {
                    ...
                    Rectangle {
                        ...
                        MessageDialog{
                            id:profileDialog
                            text:qsTr("Profile Updated Successfully.")
                        }
                    }
                }
            }
